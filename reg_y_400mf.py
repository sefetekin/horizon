...
writer = SummaryWriter("sheet2/reg_y_400mf")
...
cnn_neural_network =  torchvision.models.regnet_y_400mf(pretrained=True)
cnn_neural_network.fc = torch.nn.Linear(in_features=440, out_features=3, bias=True)
