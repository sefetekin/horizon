...
writer = SummaryWriter("sheet2/transferlearning2")
...
cnn_neural_network.load_state_dict(torch.load("C:\\Users\\pc\\OneDrive\\Masaüstü\\classified\\horizon (1)\\Experiments\\models_transfer\\model1.pk"))
