...
writer = SummaryWriter("sheet2/inception")
...
cnn_neural_network =  torchvision.models.inception_v3(pretrained=True)
cnn_neural_network.fc = torch.nn.Linear(in_features=2048, out_features=3, bias=True)
