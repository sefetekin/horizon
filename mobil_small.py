...
writer = SummaryWriter("sheet2/mobil_small")
...
cnn_neural_network =  torchvision.models.mobilenet_v3_small(pretrained=True)
cnn_neural_network.fc = torch.nn.Linear(in_features=576, out_features=3, bias=True)
