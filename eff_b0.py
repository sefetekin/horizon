...
writer = SummaryWriter("sheet2/eff_b0")
...
cnn_neural_network =  torchvision.models.efficientnet_b0(pretrained=True)
cnn_neural_network.fc = torch.nn.Linear(in_features=1280, out_features=3, bias=True)
