...
writer = SummaryWriter("sheet2/reg_y_32gf")
...
cnn_neural_network =  torchvision.models.regnet_y_32gf(pretrained=True)
cnn_neural_network.fc = torch.nn.Linear(in_features=3712, out_features=3, bias=True)
